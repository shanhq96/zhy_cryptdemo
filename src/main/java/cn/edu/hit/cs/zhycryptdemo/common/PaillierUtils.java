...
public class PaillierUtils {
    ...
    public PaillierUtils(boolean flag) {
        KeyGenerationWithPQ(512, 64);
    }


    public void KeyGenerationWithPQ(int bitLengthVal, int certainty) {
        bitLength = bitLengthVal;
        /*
         * Constructs two randomly generated positive BigIntegers that are
         * probably prime, with the specified bitLength and certainty.
    ...
    public static void main(String[] str) {
        ...
        PaillierUtils paillierUtils = new PaillierUtils(true);
